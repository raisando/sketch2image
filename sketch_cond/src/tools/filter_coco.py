...
def main():
    ...
    most_common = json.load(open(args.json))
    ...
    json_path = out_cache_dir / f"most_present_class_index_{args.split}_5cls.json"
    with json_path.open("w") as f:
        json.dump(filt_json, f, indent=2)
    print("[ok] saved:", json_path)

    embeds_path = out_cache_dir / f"clip_most_present_class_index_embeds_{args.split}_5cls.pt"
