...
class ConditionalProbabilityPath(torch.nn.Module, ABC):
    ...
    """
    def __init__(self, p_simple:distrib.Sampleable, p_data: distrib.Sampleable):
        super().__init__()
...
class GaussianConditionalProbabilityPath(ConditionalProbabilityPath):
    def __init__(self, p_data: distrib.Sampleable, alpha: ab.Alpha, beta: ab.Beta):
        p_simple = distrib.Gaussian.isotropic(p_data.dim, 1.0)
